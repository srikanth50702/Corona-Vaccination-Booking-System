        ...
        if (ae.getSource() == create) {
            ...
            try {
                ...
                if (atype.equals("Admin") ||atype.equals("User")) {
                    query = "insert into signup values( '"+atype+"', '"+susername+"', '"+sname+"', '"+spassword+"')";
                } ////else {
                   // query = "update login set username = '"+susername+"', password = '"+spassword+"', user = '"+atype+"' where roomnumber='"+number"'";
               // }
