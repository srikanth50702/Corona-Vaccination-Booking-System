...
public class Dashboard2 extends JFrame {
	...
	public Dashboard2(){
		...
		JButton btnNewCustomerForm = new JButton("Search Centres");
		btnNewCustomerForm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				search custom = new search();
		...
		JButton btnNewButton = new JButton("Apply Vaccination");
		...
		btnNewButton_7.setBounds(200, 350, 300, 60);
